...
<body>
    ...
    <header>
        <div
            ...
            <p>CAJAMARCA - PERU</p>
            <img src="crud-mvc/resources/views/empleados/Imgs/logoCaja.png" alt="Logo Cajamarca"
    ...
    <div class="login-container">
        ...
        <!-- Cuadro con imagen -->
        <div id="FondoCuadro">
            <img src="crud-mvc/resources/views/empleados/Imgs/logoCaja.png" alt="Logo Municipalidad" style="max-width:550px; max-height:550px;">
        </div>


        <!-- Formulario de Login -->
        <form id="loginForm" action="Inventario.php" method="post">
            <!-- <br>
            ...
            <br>-->
            <button type="submit" href="Inventario.php">Ingresar</button>
        </form>
    </div>
</body>
